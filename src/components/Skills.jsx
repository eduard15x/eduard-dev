      ...
      <div name='skills' className='w-full h-screen bg-[#060606] text-gray-400'>
        ...
        <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full items-center'>
            ...
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-center py-8'>
                {skillsData.map((el) => (
                    <div key={el.skill} className='shadow-sm shadow-[#50bdb7]  hover:cursor-default hover:scale-110 duration-500 bg-[#060606] py-2 pt-4'>
                        <img className='w-8 md:w-16 mx-auto' src={el.icon} alt="HTML icon" />
